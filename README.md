...
state/district/commodity/variety, and compare modal prices across markets —
built entirely on the public [data.gov.in](https://data.gov.in/) API.
...
4. **Forecast** — Daily history resampled to weekly modal price, lag + seasonal
   features built, gradient-boosting model fit, recursive multi-week forecast.
